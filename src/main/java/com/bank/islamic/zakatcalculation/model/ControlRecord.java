package com.bank.islamic.zakatcalculation.model;
...
/**
 * The BIAN control record for this service domain: "Zakat Assessment Procedure".
 *
 ...
 * to its asset type (Zakat Assessment). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Zakat Assessment Procedure";
